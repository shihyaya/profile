...
const portofolioData = [{
    name:'專家系統',
    subtitle:'養殖雲端平台',
    skill:['Vue2/Nuxt2','Figma','Axios','Vuetify'],
    job:['介面設計','程式撰寫','串接API'],
    ...
    name:'智慧水產養殖專家介紹',
    subtitle:'一頁式介紹網站',
    skill:['React/Next','Figma','Tailwind'],
    job:['介面設計','程式撰寫'],
    ...
    name:'Nusono Cloud',
    subtitle:'醫療雲端平台',
    skill:['Angular','Figma','Echarts','Material'],
    job:['介面設計','程式撰寫','串接API'],
...
export default function Portofolios() {
    return (
        <>
            <div id="portfolio" className="py-6 my-10">
                        ...
                        portofolioData.map((portofolio,i)=>{
                            return (
                                <div key={`portofolio_${i}`}>
                                    <Portofolio name={portofolio.name} subtitle={portofolio.subtitle} skill={portofolio.skill} job={portofolio.job} describe={portofolio.describe} response={portofolio.response} company={portofolio.company} id={i+1}></Portofolio>
                                </div>
                            )
                        })
                    }
